        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('hrd.update', $hrd->id) }}" method="POST" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="nip" name="nip" type="text"
                                    class="mt-1 block w-full bg-gray-100 dark:bg-gray-700" value="{{ old('nip', $hrd->nip) }}"
                                    readonly />
                            </div>
                            ...
                            <div>
                                ...
                                <x-text-input id="nama" name="nama" type="text" class="mt-1 block w-full"
                                    value="{{ old('nama', $hrd->nama) }}" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="alamat" name="alamat" type="text" class="mt-1 block w-full"
                                    value="{{ old('alamat', $hrd->alamat) }}" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="tempat_lahir" name="tempat_lahir" type="text"
                                    class="mt-1 block w-full" value="{{ old('tempat_lahir', $hrd->tempat_lahir) }}" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="tanggal_lahir" name="tanggal_lahir" type="date"
                                    ...
                                    value="{{ old('tanggal_lahir', $hrd->tanggal_lahir->format('Y-m-d')) }}"
                                    required />
                            ...
                            <div>
                                ...
                                <x-text-input id="departemen" name="departemen" type="text" class="mt-1 block w-full"
                                    value="{{ old('departemen', $hrd->departemen) }}" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="detail_jabatan" name="detail_jabatan" type="text"
                                    class="mt-1 block w-full" value="{{ old('detail_jabatan', $hrd->detail_jabatan) }}" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="edukasi" name="edukasi" type="text" class="mt-1 block w-full"
                                    value="{{ old('edukasi', $hrd->edukasi) }}" required />
                            ...
                            <div>
                                ...
                                <select id="gender" name="gender" required
                                    ...
                                    <option value="male" {{ old('gender', $hrd->gender) == 'male' ? 'selected' : '' }}>
                                        Laki-laki</option>
                                    <option value="female" {{ old('gender', $hrd->gender) == 'female' ? 'selected' : '' }}>
                                        Perempuan</option>
                                </select>
                            ...
                            <div>
                                ...
                                <x-text-input id="no_telepon" name="no_telepon" type="text" class="mt-1 block w-full"
                                    value="{{ old('no_telepon', $hrd->no_telepon) }}" required />
