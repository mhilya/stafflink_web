                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @auth
                        ...
                        @if (auth()->user()->isManajer())
                            <x-nav-link :href="route('manajer.index')" :active="request()->routeIs('manajer.index')">
                                {{ __('Manajer') }}
                            </x-nav-link>

                            <x-nav-link :href="route('manajer.karyawan.index')" :active="request()->routeIs('manajer.karyawan.index')">
                                {{ __('Data Karyawan') }}
                            </x-nav-link>
                        @endif

                        @if (auth()->user()->isHrd())
                            <x-nav-link :href="route('hrd.index')" :active="request()->routeIs('hrd.index')">
                                {{ __('HRD') }}
                            </x-nav-link>
                            <x-nav-link :href="route('hrd.karyawan.index')" :active="request()->routeIs('hrd.karyawan.*')">
                                {{ __('Data Karyawan') }}
                            </x-nav-link>
                            <x-nav-link :href="route('hrd.manajer.index')" :active="request()->routeIs('hrd.manajer.*')">
                                {{ __('Data Manajer') }}
                            </x-nav-link>
                        @endif
                    @endauth
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @auth
                ...
                @if (auth()->user()->isManajer())
                    <x-responsive-nav-link :href="route('manajer.index')" :active="request()->routeIs('manajer.index')">
                        {{ __('Manajer') }}
                    </x-responsive-nav-link>
