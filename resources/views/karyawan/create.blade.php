<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Isi Data Karyawan') }}
        </h2>
        <p class="text-gray-600 dark:text-gray-400 text-sm mt-1">
            Silakan lengkapi form berikut untuk mengisi data karyawan Anda.
        </p>
    </x-slot>
                    ...
                    <form action="{{ route('karyawan.store') }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="departemen" name="departemen" type="text" class="mt-1 block w-full" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="detail_jabatan" name="detail_jabatan" type="text" class="mt-1 block w-full" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="edukasi" name="edukasi" type="text" class="mt-1 block w-full" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="no_telepon" name="no_telepon" type="text" class="mt-1 block w-full" required />
