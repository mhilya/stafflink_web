        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('manajer.karyawan.update', $karyawan->id) }}" method="POST" class="space-y-6">
                        @csrf
                        @method('PUT')
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="tempat_lahir" name="tempat_lahir" type="text"
                                    class="mt-1 block w-full" value="{{ old('tempat_lahir', $karyawan->tempat_lahir) }}" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="detail_jabatan" name="detail_jabatan" type="text"
                                    class="mt-1 block w-full" value="{{ old('detail_jabatan', $karyawan->detail_jabatan) }}" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="edukasi" name="edukasi" type="text" class="mt-1 block w-full"
                                    value="{{ old('edukasi', $karyawan->edukasi) }}" required />
                            ...
                            <div>
                                ...
                                <select id="gender" name="gender" required
                                    ...
                                    <option value="male" {{ old('gender', $karyawan->gender) == 'male' ? 'selected' : '' }}>
                                        Laki-laki</option>
                                    <option value="female" {{ old('gender', $karyawan->gender) == 'female' ? 'selected' : '' }}>
                                        Perempuan</option>
                                </select>
