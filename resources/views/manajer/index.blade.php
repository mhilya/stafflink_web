        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            @if (!$manajer)
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6 text-center">
                    <p class="text-gray-600 dark:text-gray-400 mb-4">Anda belum memiliki data manajer.</p>
                    <x-primary-button href="{{ route('manajer.create') }}">
                        Tambah Data Manajer
                    </x-primary-button>
                </div>
            @else
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-900 dark:text-gray-100">
                                            {{ $manajer->tempat_lahir }}, {{ $manajer->tanggal_lahir->translatedFormat('d F Y') }}
                                        </p>
                                    </div>
                                    <div>
                            ...
                            <section>
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-900 dark:text-gray-100">{{ ucfirst($manajer->user->role->name) }}</p>
                                    </div>
                                    <div>
                    ...
                    <div class="px-6 py-4 bg-gray-50 dark:bg-gray-700 border-t border-gray-200 dark:border-gray-600 flex justify-end">
                        <a href="{{ route('manajer.edit', $manajer->id) }}"
