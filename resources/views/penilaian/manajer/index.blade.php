<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Penilaian Kompetensi Manajer') }}
        </h2>
    </x-slot>
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('penilaian.manajer.store') }}">
                        ...
                        <div id="print-area">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="nip" value="{{ $manajerSelected->nip ?? '' }}"
                                        class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                                        readonly>
                                </div>
                                <div>
                                    ...
                                    <input type="text" id="status" value="{{ $manajerSelected->status ?? '' }}"
                                        class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                                        readonly>
                                </div>
                                <div>
                                    ...
                                    <input type="text" id="jabatan"
                                        value="{{ $manajerSelected->user->role->name ?? '' }}"
                                        class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                                        readonly>
                                </div>
                                <div>
                                    <label
                                        ...
                                        Jabatan</label>
                                    <input type="text" id="detail_jabatan"
                                        value="{{ $manajerSelected->detail_jabatan ?? '' }}"
                                        class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                                        readonly>
                                </div>
                                <div>
                                    ...
                                    <input type="text" id="departemen"
                                        value="{{ $manajerSelected->departemen ?? '' }}"
                                        class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                                        readonly>
                                </div>
                                ...
                                <div>
                                    <div class="mb-6">
                                        ...
                                        <textarea name="corrective_action" rows="3"
                                            class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white"></textarea>
                                    </div>
                                    <div>
                                        <p class="font-bold mb-2 text-gray-800 dark:text-white">Feedback dari Manajer
                                            terkait</p>
                                        <textarea name="feedback_manajer" rows="3"
                                            class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white"></textarea>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="flex justify-end gap-4 mt-8 no-print">
                            ...
                            <button type="submit"
                                class="bg-blue-600 text-white px-4 py-2 rounded text-xs font-semibold hover:bg-blue-700 uppercase tracking-wider transition-colors">Simpan</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script>
        ...
        document.getElementById('manajer_id')?.addEventListener('change', function() {
