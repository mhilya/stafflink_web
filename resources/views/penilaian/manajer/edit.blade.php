        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('penilaian.manajer.update', $penilaian->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div id="print-area">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" value="{{ $penilaian->manajer->nip }}"
                                        class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                                        readonly>
                                </div>
                                <div>
                                    ...
                                    <input type="text" value="{{ $penilaian->manajer->status }}"
                                        class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                                        readonly>
                                </div>
                                <div>
                                    ...
                                    <input type="text" value="{{ $penilaian->manajer->user->role->name }}"
                                        class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                                        readonly>
                                </div>
                                <div>
                                    <label
                                        ...
                                        Jabatan</label>
                                    <input type="text" value="{{ $penilaian->manajer->detail_jabatan }}"
                                        class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                                        readonly>
                                </div>
                                <div>
                                    ...
                                    <input type="text" value="{{ $penilaian->manajer->departemen }}"
                                        class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                                        readonly>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div>
                                        ...
                                        <textarea name="feedback_manajer" rows="3"
                                            class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white">{{ $penilaian->feedback_manajer }}</textarea>
                                    </div>
                                </div>
                            </div>
