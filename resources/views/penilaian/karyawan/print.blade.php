...
<body>
    ...
    <table class="info-table">
        <tr>
            ...
            <td width="15%">{{ $penilaian->karyawan->nama }}</td>
            <td class="label">NIP</td>
            <td width="15%">{{ $penilaian->karyawan->nip }}</td>
            <td class="label">Jabatan</td>
            <td width="15%">{{ ucfirst($penilaian->karyawan->user->role->name) ?? '-' }}</td>
            <td class="label">Detail Jabatan</td>
            <td width="15%">{{ $penilaian->karyawan->detail_jabatan ?? '-' }}</td>
        </tr>
        <tr>
            <td class="label">Departemen</td>
            <td>{{ $penilaian->karyawan->departemen }}</td>
    ...
    <table class="summary-table">
        <tr>
            <td class="summary-cell" colspan="3">
    ...
    <table class="signature-table">
        <tr>
            <td class="table-feedback-box">
                <strong>Feedback Karyawan:</strong><br>
                {{ $penilaian->feedback_karyawan ?? '-' }}<br><br>
            ...
            <td class="table-signature-box">
                ...
                <div>Mengetahui,</div>
                <div class="signature-line"></div>
                <div><strong>{{ $penilaian->karyawan->nama }}</strong></div>
            </td>
        </tr>
    </table>
</body>
