<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Penilaian Kompetensi Karyawan') }}
        </h2>
    </x-slot>
                        ...
                        <div id="print-area">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="nip" value="{{ $karyawanSelected->nip ?? '' }}"
                                        class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                                        readonly>
                                </div>
                                <div>
                                    ...
                                    <input type="text" id="status" value="{{ $karyawanSelected->status ?? '' }}"
                                        class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                                        readonly>
                                </div>
                                <div>
                                    ...
                                    <input type="text" id="jabatan"
                                        value="{{ $karyawanSelected->user->role->name ?? '' }}"
                                        class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                                        readonly>
                                </div>
                                <div>
                                    ...
                                    <input type="text" id="detail_jabatan"
                                        value="{{ $karyawanSelected->detail_jabatan ?? '' }}"
                                        class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                                        readonly>
                                </div>
                                <div>
                                    ...
                                    <input type="text" id="departemen"
                                        value="{{ $karyawanSelected->departemen ?? '' }}"
                                        class="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                                        readonly>
                                </div>
